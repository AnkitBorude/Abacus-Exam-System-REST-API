...
examRouter.route('/practice/:examId/analytics').get(authMiddleware,getPracticeexamnAnalytics);
examRouter.route('/assessment/:examId/analytics').get(authMiddleware,getAssessmentexamAnalytics);
examRouter
