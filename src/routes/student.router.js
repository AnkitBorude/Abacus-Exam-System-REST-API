...
studentRouter
    .route('/exam/practice/analytics')
    .get(authMiddleware, getStudentPracticeExamAnalytics);
studentRouter
    .route('/:studentId/exam/practice/analytics')
    .get(authMiddleware, getStudentPracticeExamAnalytics);
studentRouter
    .route('/:studentId/exam/assessment/analytics')
    .get(authMiddleware, getStudentAssessmentExamAnalytics);
studentRouter
    .route('/exam/assessment/analytics')
    .get(authMiddleware, getStudentAssessmentExamAnalytics);
