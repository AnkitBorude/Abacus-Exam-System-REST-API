...
async function startLocalmongoDBserver() {
    ...
    return new Promise((resolve,reject)=>{
        console.log(chalk.yellowBright("Stating Localhost MongoDB service..Initiating Check Sequence..."));
        console.log(chalk.blueBright("1 Checking scriptpath variable exists..."));
        if(typeof scriptPath != "string")
        {
            reject("scriptpath variable is not defined or have invalid datatype");
            return;
        }
        ...
        console.log(chalk.blueBright("4 Spawning a child process for mongodb startup script..."));
