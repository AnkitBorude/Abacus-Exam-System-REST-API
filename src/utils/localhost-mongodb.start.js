...
async function startLocalmongoDBserver() {
    ...
    return new Promise((resolve, reject) => {
        console.log('Stating Localhost MongoDB service..Initiating Check Sequence...'
        );
        console.log(
           '1 Checking scriptpath variable exists...'
        );
        ...
        console.log('2 Checking mongodb script file path...');
        if (!fs.existsSync(scriptPath)) {
            reject('mongodb startup script file does not exists...');
            return;
        }
        console.log('3 Checking for valid script file...');
